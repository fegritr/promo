	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form action="<?php echo base_url()."index.php/c_akun/register"?>" class="login100-form validate-form p-l-55 p-r-55 p-t-178" method="post">
					...
					<div class="flex-col-c p-t-170 p-b-40">
						...
						<a href="<?php echo base_url()."index.php/c_akun/login"?>" class="txt3">
							Sign In
						</a>
					</div>
				</form>
