...
<div class="cat-list clearfix">
 ...
 <br>
      ...
      <?php if($this->session->userdata('logged_in' )&& in_array("2", $roles)){?>
              ...
              <?php if(in_array("tiket", $subscribtion)){?>
      ...
      <?php foreach($tiket as $item){?>
        ...
        <div class="col-lg-<?php echo $bootstrapColWidth;?> portfolio-item">
          ...
          <?php if($this->session->userdata('logged_in') && in_array("2", $roles)){?>
            ...
            <img class="card-img-top top-right" style="position:absolute; " src="<?php echo base_url()?>assets/img/shopee.png" >
            <?php }else if($item['toko'] == 'tiketcom'){ ?>
            <img class="card-img-top top-right" style="position:absolute; " src="<?php echo base_url()?>assets/img/tiketcom.png" ><?php }?>
            ...
            <div class="card-body d-flex flex-column">
              ...
              <input type="text" id ="" value="" readonly style="width: fit-content; border: none; font-size:13px; font-weight:bold; color:transparent;">
                <button  class="btn pull-right" style="width: fit-content; background-color:transparent;" id="right-panel-link"><i class ="fa fa-copy" style="color:transparent;"></i> </button>
              <?php }else{ ?>
