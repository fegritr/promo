...
<br>
      ...
      <?php if($this->session->userdata('logged_in' )&& $this->session->userdata('username')!= 'admin'){?>
              ...
              <?php if(in_array("bankkeuangan", $subscribtion)){?>
                      <form method="post" action="<?php echo base_url().'index.php/c_akun/unsubscribe'?>">
                      <button type="submit"  class="btn" style="background-color:transparent;">
                      <input type="hidden" name="kategori" value="bankkeuangan">
                      <span class="btn-label"><i class="material-icons">notifications</i>Unsubscribe</span></button>
                      </form>
              <?php }else{?>
